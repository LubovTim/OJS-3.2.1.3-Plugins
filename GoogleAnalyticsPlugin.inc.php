...
class GoogleAnalyticsPlugin extends GenericPlugin {
	...
	function registerScript($hookName, $params) {
		...
		$googleAnalyticsCode1 = "<script async src=https://www.googletagmanager.com/gtag/js?id='$googleAnalyticsSiteId'></script>";

		$googleAnalyticsCode = "

</script>
<script async src=https://www.googletagmanager.com/gtag/js?id='$googleAnalyticsSiteId'></script>
<script>
